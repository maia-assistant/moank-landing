export default function Pricing() {
  return (
    <section id="pricing" className="py-20 sm:py-32 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-8 text-center text-white">
              <p className="text-emerald-100 font-medium">Ränta från</p>
              <div className="mt-2 flex items-baseline justify-center gap-2">
                <span className="text-5xl sm:text-6xl font-bold">4,5</span>
                <span className="text-2xl">%</span>
              </div>
              <p className="mt-2 text-emerald-100">per år (effektiv ränta)</p>
            </div>

            <div className="p-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Räkneexempel</h3>
              
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Lånebelopp</span>
                  <span className="font-semibold text-gray-900">100 000 kr</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Ränta</span>
                  <span className="font-semibold text-gray-900">4,5% per år</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Lånetid</span>
                  <span className="font-semibold text-gray-900">1 år</span>
                </div>
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Räntekostnad</span>
                    <span className="font-semibold text-gray-900">4 500 kr</span>
                  </div>
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-gray-600">Totalt att betala</span>
                    <span className="font-bold text-lg text-emerald-600">104 500 kr</span>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-12 max-w-2xl mx-auto">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-semibold text-amber-800">Tänk på</h4>
