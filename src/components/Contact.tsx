export default function Contact() {
  return (
    <section id="contact" className="py-20 sm:py-32 bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">08-XXX XX XX</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">info@moank.se</p>
                </div>
              </div>
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="1m-2m">1 - 2 miljoner kr</option>
                  <option value="2m-5m">2 - 5 miljoner kr</option>
                  <option value="5m+">Över 5 miljoner kr</option>
                </select>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="consent" className="text-sm text-gray-600">
                  ...
                  <a href="#" className="text-emerald-600 hover:underline">integritetspolicyn</a>.
                </label>
              </div>

              <button
                type="submit"
                className="w-full px-6 py-4 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200 hover:shadow-xl hover:shadow-emerald-300"
              >
                Skicka förfrågan
              </button>
            </form>
